...
//--------------------------------------------------------------------------------//
    public static function TipoUsuario($tipo){
         ...
         $sql = "SELECT  U.nombre, U.email, U.password 
                FROM usuarios U
                WHERE  U.perfil = :perfil";

        $consulta = $objetoAccesoDato->RetornarConsulta($sql);
        $consulta->bindValue(':perfil', $tipo->tipo, PDO::PARAM_STR);
       
        $consulta->execute();

        $usuarioVerificado = $consulta->fetchObject('Usuario');

        return $usuarioVerificado;
    }


    public static function VerificarLogin($obj) {
        $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso();

        $sql = "SELECT U.id, U.nombre, U.email, U.perfil /*, U.foto*/
                FROM usuarios U
                WHERE (U.email = :email or U.nombre = :nombre) AND U.password = :pass";
